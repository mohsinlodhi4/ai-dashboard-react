...
export default function LandingPage() {
  return (
    <div>
      <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-transparent text-sm py-3 border-b border-[#1E429F] relative">
        <nav
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="sm:hidden">
              <button
                type="button"
                className="hs-collapse-toggle w-9 h-9 flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-white/20 text-black hover:border-white/40 disabled:opacity-50 disabled:pointer-events-none "
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
              <Link to="/login">
                <span
                  className="flex items-center gap-x-2 bg-[#1E429F] w-fit px-5 py-3 rounded-full font-medium text-white"
                  href="#"
                >
                  <svg
      ...
      <div className="bg-white">
        <div className="relative isolate px-6 pt-14 lg:px-8">
          <div
            ...
            aria-hidden="true"
          >
            <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#1E429F] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"></div>
          </div>
          <div className="mx-auto md:max-w-[40%] py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                AI Dashboard Creates Your Own ChatGPT with ALL Your Business
                Content.
              </h1>
            ...
            <div className="flex flex-row items-center justify-center py-5">
              <Link to="/signup">
                <span
                  className="bg-[#1E429F] text-white py-3 px-7 rounded-full"
                  href="#"
                >
                  GET STARTED
                </span>
      ...
      <div className="max-w-[85rem] px-7 py-10 sm:px-6 lg:px-8 lg:py-28 mx-auto">
      ...
      <div className="bg-[#1E429F] md:py-20 p-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-5 min-h-full p-6 md:max-w-[54%] m-auto">
          <div className="flex flex-col gap-6 md:w-[50%]">
            ...
            <p className="text-white">
              Protect your brand and business integrity with accurate answers,
              without hallucinations. No making up facts here.
            </p>
            ...
            <div className="flex flex-row items-center gap-2">
              <CheckIcon className="text-white" />
              <p className="text-white">Support Helpdesks</p>
            </div>
            <div className="flex flex-row items-center gap-2">
              <CheckIcon className="text-white" />
              <p className="text-white">Researching Documents</p>
            </div>
            <Link to="/signup">
              <span
                className="bg-white text-[#1E429F] w-fit py-3 px-7 rounded-full"
                href="#"
              >
                SIGN UP
              </span>
          ...
          <div className="md:w-[50%]">
            <img
              src=" https://img.freepik.com/free-photo/person-laptop-using-artificial-intelligence-generate-image_23-2150570994.jpg?w=1800&t=st=1704024950~exp=1704025550~hmac=40083df6ae8c743823c3261f91f216026b1450c67b17d73a0bc21183136b5c52"
              alt=""
      ...
      <div className="flex md:flex-row flex-col gap-7 items-start justify-between m-auto w-full md:max-w-[53%] px-6 pt-4 md:pt-28">
        <div className="text-center flex flex-col gap-2">
          <img
            src="https://img.freepik.com/free-photo/person-using-ai-tool-job_23-2150711490.jpg?w=1800&t=st=1704023004~exp=1704023604~hmac=d5c30e6e220d88400e9fb468b052a6f4f14cf67cd9f5453e2b448a7486941a58"
            alt=""
            className="rounded-lg"
          />
          <h3 className="text-2xl font-bold">Train AI on your expertise</h3>
          <p>
            Use your own documents, data, and directions to make AI work for
            you.
          </p>
        </div>
        <div className="text-center flex flex-col gap-2">
          <img
            src="https://img.freepik.com/free-photo/friends-outdoors-city-looking-smartphone_23-2149023660.jpg?w=1800&t=st=1704023202~exp=1704023802~hmac=5f811493dacd5541ee500aaa6225e06b284e108cd9f0a7ea1df7db8a17971546"
            alt=""
            className="rounded-lg"
          />
        ...
        <div className="text-center flex flex-col gap-2">
          <img
            src="https://img.freepik.com/free-photo/business-man-sitting-desk_23-2148349965.jpg?w=1800&t=st=1704023278~exp=1704023878~hmac=0b06118c1afa7671cb403a0169ffbf3849dbd5febda97371a26a91ed27c6b000"
            alt=""
            className="rounded-lg"
          />
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
          <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 ">
            <h4 className="font-medium text-lg text-black ">Free</h4>
            <span className="mt-7 font-bold text-5xl text-black ">Free</span>
            <p className="mt-2 text-sm text-gray-500">Forever free</p>

            <ul className="mt-7 space-y-2.5 text-sm">
              <li className="flex space-x-2">
                <svg
                  className="flex-shrink-0 mt-0.5 h-4 w-4 text-[#1E429F] "
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <li className="flex space-x-2">
                ...
                <span className="text-black ">Product support</span>
              </li>
            </ul>
            <Link to="/signup">
              <span
          ...
          <div className="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 ">
            ...
            <h4 className="font-medium text-lg text-black ">Startup</h4>
            <span className="mt-5 font-bold text-5xl text-black ">
            ...
            <Link to="/signup">
              <span className="mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#1E429F] text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none ">
                Sign up
              </span>
            </Link>
          </div>
          <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 ">
            <h4 className="font-medium text-lg text-black ">Team</h4>
            <span className="mt-5 font-bold text-5xl text-black ">
              <span className="font-bold text-2xl">$</span>
              89
            </span>
            ...
            <ul className="mt-7 space-y-2.5 text-sm">
              <li className="flex space-x-2">
                ...
                <span className="text-black ">5 users</span>
              </li>
            ...
            <Link to="/signup">
              <span className="mt-5 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-100 text-blue-800 hover:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none ">
                Sign up
              </span>
            </Link>
          </div>
          <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 ">
            <h4 className="font-medium text-lg text-black ">Enterprise</h4>
            <span className="mt-5 font-bold text-5xl text-black ">
              <span className="font-bold text-2xl">$</span>
              149
            </span>
            ...
            <ul className="mt-7 space-y-2.5 text-sm">
              <li className="flex space-x-2">
                ...
                <span className="text-black ">10 users</span>
              </li>
      ...
      <div>
        <h2 className="text-center text-4xl font-bold text-black pt-14 pb-10">
          Testimonails
        </h2>

        <div className="md:max-w-[60%] px-4 py-10 sm:px-6 lg:px-8 lg:py-5 mx-auto">
      ...
      <div>
        ...
        <div className="w-full max-w-5xl m-auto">
          <div className="px-4 py-10 sm:px-6 lg:px-8 lg:py-5 mx-auto">
      ...
      <footer className="w-full  bg-gray-100 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div className="text-center">
          <div>
            <a
